...
public class AppKeywords extends GenericKeywords{
	...
	public void defaultLogin(){
		...
		String loginlink_xpath=prop.getProperty("loginlink_xpath");
		test.log(Status.INFO, "Logging in with default ID"+loginlink_xpath);
		...
		String username=prop.getProperty("username_xpath");
		String password=prop.getProperty("pwd_xpath");
		String username_default=prop.getProperty("username_default");
		String pwd_default=prop.getProperty("pwd_default");
		type(username,username_default);
		type(password,pwd_default);
		System.out.println("Default username "+username );
		System.out.println("Default password "+password );
		
		String submit_xpath=prop.getProperty("submit_xpath");
        click(submit_xpath);
        try {
			wait(2000);
		} catch (InterruptedException e) {
