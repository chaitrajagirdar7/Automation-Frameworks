package AutomationFrameworks.util;
...
public class Constants {
	...
	public static final String GECKODRIVER =System.getProperty("user.dir")+"\\geckodriver.exe";
	public static final String CHROMEDRIVER =System.getProperty("user.dir")+"\\chromedriver.exe";
